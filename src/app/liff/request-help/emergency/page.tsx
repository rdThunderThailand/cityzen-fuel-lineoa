  ...
  return (
    <div className="min-h-screen bg-[#ff4d4f] flex flex-col font-sans text-white">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pt-12 pb-8">
        ...
        {/* Text */}
        <h2 className="text-[24px] font-extrabold mb-3 text-center">
          เหตุฉุกเฉินด่วน
        </h2>
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <a
            href="tel:1669"
            className="bg-white rounded-2xl p-5 flex items-center justify-between shadow-lg shadow-red-900/20 active:scale-[0.98] transition-transform"
          >
            <div>
              <h3 className="text-[#ff4d4f] text-[20px] font-extrabold mb-1">
                โทร 1669
              </h3>
              <p className="text-[#ff4d4f]/60 text-[13px] font-medium">
                สายด่วนการแพทย์ฉุกเฉิน
              </p>
            </div>
          ...
          >
            <div>
              <h3 className="text-[#304052] text-[20px] font-extrabold mb-1">
                โทร 191
              </h3>
